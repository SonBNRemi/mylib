...
class UIConstraintLayout @JvmOverloads constructor(
    ...
    init {
        ...
        val topRight = typedArray.getDimension(R.styleable.UIConstraintLayout_android_topRightRadius, 0f)
        val bottomLeft = typedArray.getDimension(R.styleable.UIConstraintLayout_android_bottomLeftRadius, 0f)
        val bottomRight =
            typedArray.getDimension(R.styleable.UIConstraintLayout_android_bottomRightRadius, 0f)
        typedArray.recycle()
